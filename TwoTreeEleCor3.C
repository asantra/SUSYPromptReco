...
void TwoTreeEleCor3(){
  ...
  //// histograms ////
  TFile *FF = new TFile("PromptRecoElectronCorPfMet3.root","RECREATE");
  ...
  FILE *myfile;
  myfile=fopen("file_ele_ReReco3_Sorted.txt", "r");
  char line[50];
  int z1=0;
  const int linesize = 330138 ;
  ...
  for(int f=0;f<linesize;++f){
    FILE *myfile1;
    myfile1=fopen("file_ele_Prompt3_Sorted.txt", "r");
    char line1[50];
