...
void TwoTreeEleCor10(){
  ...
  //// histograms ////
  TFile *FF = new TFile("PromptRecoElectronCorPfMet10.root","RECREATE");
  ...
  FILE *myfile;
  myfile=fopen("file_ele_ReReco10_Sorted.txt", "r");
  char line[50];
  int z1=0;
  const int linesize = 213211 ;
  ...
  for(int f=0;f<linesize;++f){
    FILE *myfile1;
    myfile1=fopen("file_ele_Prompt10_Sorted.txt", "r");
    char line1[50];
