...
void TwoTreeEleCor12(){
  ...
  b1a.Add("PhotonAll_Tree.root"); // corrected PfMet from rereco
  ...
  //// histograms ////
  TFile *FF = new TFile("PromptRecoElectronCorPfMet12.root","RECREATE");


  TH1F* h_met_prompt_ffdiEMPtreweighted(new TH1F("h_met_prompt_ffdiEMPtreweighted","prompt #slash{E}_{T}, diEMPtreweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_prompt_ffrhoreweighted(new TH1F("h_met_prompt_ffrhoreweighted","prompt #slash{E}_{T}, rhoreweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_prompt_ffrhodiEMPtreweighted(new TH1F("h_met_prompt_ffrhodiEMPtreweighted","prompt #slash{E}_{T}, rhodiEMptreweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_rereco_ffdiEMPtreweighted(new TH1F("h_met_rereco_ffdiEMPtreweighted","rereco #slash{E}_{T}, diEMPtreweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_rereco_ffrhoreweighted(new TH1F("h_met_rereco_ffrhoreweighted","rereco #slash{E}_{T}, rhoreweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_rereco_ffrhodiEMPtreweighted(new TH1F("h_met_rereco_ffrhodiEMPtreweighted","rereco #slash{E}_{T}, rhodiEMptreweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_rho_prompt_diEMPtreweighted(new TH1F("h_rho_prompt_diEMPtreweighted","prompt rho, diEMPt reweighted to candidate, Asymmetric Pt ;rho;Events", 40, 0., 40.));
  TH1F* h_rho_rereco_diEMPtreweighted(new TH1F("h_rho_rereco_diEMPtreweighted","rereco rho, diEMPt reweighted to candidate, Asymmetric Pt ;rho;Events", 40, 0., 40.));
  TH1F* h_rho_prompt_ffdiEMPtreweighted(new TH1F("h_rho_prompt_ffdiEMPtreweighted","prompt rho, diEMPt reweighted to ff, Asymmetric Pt ;rho;Events", 40, 0., 40.));
  TH1F* h_rho_rereco_ffdiEMPtreweighted(new TH1F("h_rho_rereco_ffdiEMPtreweighted","rereco rho, diEMPt reweighted to ff, Asymmetric Pt ;rho;Events", 40, 0., 40.));

  TH1F* h_met_prompt_diEMPtrhodiEMPtreweighted(new TH1F("h_met_prompt_diEMPtrhodiEMPtreweighted","prompt #slash{E}_{T}, diEMPt reweighted rho and diEMPt reweighted to candidate, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_prompt_diEMPtrhoreweighted(new TH1F("h_met_prompt_diEMPtrhoreweighted","prompt #slash{E}_{T}, diEMPt reweighted rho reweighted to candidate, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_prompt_ffdiEMPtrhodiEMPtreweighted(new TH1F("h_met_prompt_ffdiEMPtrhodiEMPtreweighted","prompt #slash{E}_{T}, diEMPt reweighted rho and diEMPt reweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_prompt_ffdiEMPtrhoreweighted(new TH1F("h_met_prompt_ffdiEMPtrhoreweighted","prompt #slash{E}_{T}, diEMPt reweighted rho reweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  ...
  TH1F* h_met_rereco_diEMPtrhoreweighted(new TH1F("h_met_rereco_diEMPtrhoreweighted","rereco #slash{E}_{T}, diEMPt reweighted rho reweighted to candidate, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_rereco_ffdiEMPtrhodiEMPtreweighted(new TH1F("h_met_rereco_ffdiEMPtrhodiEMPtreweighted","rereco #slash{E}_{T}, diEMPt reweighted rho and diEMPt reweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_rereco_ffdiEMPtrhoreweighted(new TH1F("h_met_rereco_ffdiEMPtrhoreweighted","rereco #slash{E}_{T}, diEMPt reweighted rho reweighted to ff, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  ...
  TH1F *h_met_eeSample_DiEMPtRhoReweightedPrompt_ErrorFromDiEMPt[1000];
  TH1F *h_met_eeSample_DiEMPtRhoReweightedPrompt_ErrorFromRho[1000];

  TH1F* h_met_prompt_diEMPtreweighted(new TH1F("h_met_prompt_diEMPtreweighted","prompt #slash{E}_{T}, diEMPtreweighted to candidate, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_prompt_rhoreweighted(new TH1F("h_met_prompt_rhoreweighted","prompt #slash{E}_{T}, rhoreweighted to candidate, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  TH1F* h_met_prompt_rhodiEMPtreweighted(new TH1F("h_met_prompt_rhodiEMPtreweighted","prompt #slash{E}_{T}, rhodiEMptreweighted to candidate, Asymmetric Pt ;#slash{E}_{T} (GeV);Events / GeV", 200, 0., 200.));
  ...
  TH1F* h_rho_prompt(new TH1F("h_rho_prompt","prompt rho, Asymmetric Pt ;rho;Events", 40, 0., 40.));
  TH1F* h_rho_rereco(new TH1F("h_rho_rereco","rereco rho, Asymmetric Pt ;rho;Events", 40, 0., 40.));
  TH1F* h_rho_difference(new TH1F("h_rho_difference","rereco-prompt rho, Asymmetric Pt ;rho;Events", 50, -25., 25.)); 
  ...
  char *histNameeePrompt       = new char[50];
  char *histtitleeePrompt      = new char[50];
  char *histNameeePrompt2      = new char[50];
  char *histtitleeePrompt2     = new char[50];
   ...
   for (int d=0;d<1000; ++d) {
     ...
     sprintf(histNameeePrompt, "DiEMPtReweightedeePrompt%d",d+1);
     sprintf(histtitleeePrompt,"Reweighted ee MET with DIEMPT prompt %d",d+1);
     h_met_eeSample_DiEMPtRhoReweightedPrompt_ErrorFromDiEMPt[d]=new TH1F(histNameeePrompt,histtitleeePrompt,200,0.0,200.0);

     sprintf(histNameeePrompt2, "RhoReweightedeePrompt%d",d+1);
     sprintf(histtitleeePrompt2,"Reweighted ee MET with RHO prompt %d",d+1);
     h_met_eeSample_DiEMPtRhoReweightedPrompt_ErrorFromRho[d]=new TH1F(histNameeePrompt2,histtitleeePrompt2,200,0.0,200.0);
  ...
  TH1F *ElectronRhoPrompt= (TH1F*)Fnew->Get("ElectronRhoPrompt");
  ...
  TH1F *FakeElectronRho= (TH1F*)Fnew->Get("FakeElectronRho");
  TH1F *FakeElectronDiEMPt= (TH1F*)Fnew->Get("FakeElectronDiEMPt");
  TH1F *FakeElectronRhoPrompt=(TH1F*)Fnew->Get("FakeElectronRhoPrompt");
  TH1F *FakeElectronDiEMPtPrompt=(TH1F*)Fnew->Get("FakeElectronDiEMPtPrompt");
  TH1F *FakeElectrondiEMPtReweightedRho=(TH1F*)Fnew->Get("FakeElectrondiEMPtReweightedRho");
  TH1F *FakeElectrondiEMPtReweightedRhoPrompt=(TH1F*)Fnew->Get("FakeElectrondiEMPtReweightedRhoPrompt");
  ...
  TH1F *EEDiEMPtRatioPrompt[1000]; 
  TH1F *EERhoRatioPrompt[1000];
   ...
   for(int g=0; g<1000; ++g){
     ...
     sprintf(nameGraph3,"ElectronDiEMPtPromptRandom%d",g+1);
     EEDiEMPtRatioPrompt[g] = (TH1F*)F2->Get(nameGraph3);

     sprintf(nameGraph4,"ElectronRhoRandomPrompt%d",g+1);
     EERhoRatioPrompt[g] = (TH1F*)F2->Get(nameGraph4);
   }
 
  /////  getting the rereco event list ////////

  FILE *myfile;
  myfile=fopen("file_ele_ReReco12_Sorted.txt", "r");
  char line[50];
  int z1=0;
  const int linesize = 162555 ;
  ...
  for(int f=0;f<linesize;++f){
    FILE *myfile1;
    myfile1=fopen("file_ele_Prompt12_Sorted.txt", "r");
    char line1[50];
    ...
    if(same==1){
      ...
      h_met_rereco_diEMPtrhoreweighted->Fill(metet, Weight22);
      ...
      h_rho_rereco_diEMPtreweighted->Fill(rho, Weight1);




      int Binff1=FakeElectronDiEMPt->FindBin(DIEMPT);
      float Weightff1=FakeElectronDiEMPt->GetBinContent(Binff1);
      int Binff2=FakeElectronRho->FindBin(rho);
      float Weightff2=FakeElectronRho->GetBinContent(Binff2);
      int Binff22=FakeElectrondiEMPtReweightedRho->FindBin(rho);
      float Weightff22=FakeElectrondiEMPtReweightedRho->GetBinContent(Binff22);
      h_met_rereco_ffdiEMPtreweighted->Fill(metet,Weightff1);
      h_met_rereco_ffrhoreweighted->Fill(metet,Weightff2);
      h_met_rereco_ffrhodiEMPtreweighted->Fill(metet, Weightff1*Weightff2);
      h_met_rereco_ffdiEMPtrhoreweighted->Fill(metet, Weightff22);
      h_met_rereco_ffdiEMPtrhodiEMPtreweighted->Fill(metet, Weightff22*Weightff1);
      




      h_rho_rereco_ffdiEMPtreweighted->Fill(rho, Weightff1);




      h_rho_rereco->Fill(rho);
      ...
      /* reweighting */
      int Bin3=ElectronDiEMPtPrompt->FindBin(DIEMPTprompt);
      float Weight3=ElectronDiEMPtPrompt->GetBinContent(Bin3);
      int Bin4=ElectronRhoPrompt->FindBin(rhoprompt);
      float Weight4=ElectronRhoPrompt->GetBinContent(Bin4);
      int Bin44=ElectrondiEMPtReweightedRhoPrompt->FindBin(rhoprompt);
      float Weight44=ElectrondiEMPtReweightedRhoPrompt->GetBinContent(Bin44);
      h_met_prompt_diEMPtreweighted->Fill(metetprompt,Weight3);
      h_met_prompt_rhoreweighted->Fill(metetprompt,Weight4);
      h_met_prompt_rhodiEMPtreweighted->Fill(metetprompt, Weight3*Weight4);
      h_met_prompt_diEMPtrhodiEMPtreweighted->Fill(metetprompt, Weight44*Weight3);
      h_met_prompt_diEMPtrhoreweighted->Fill(metetprompt, Weight44);

      for( int s=0 ; s<1000; ++s){
        float Weightprop = EEDiEMPtRatioPrompt[s]->GetBinContent(Bin3);
        h_met_eeSample_DiEMPtRhoReweightedPrompt_ErrorFromDiEMPt[s]->Fill(metetprompt, Weightprop);
      }
      for( int t=0 ; t<1000; ++t){
        float WeightFromRho = EERhoRatioPrompt[t]->GetBinContent(Bin44);
        h_met_eeSample_DiEMPtRhoReweightedPrompt_ErrorFromRho[t]->Fill(metetprompt, WeightFromRho);
      }


      h_rho_prompt_diEMPtreweighted->Fill(rhoprompt, Weight3);
     

      int Binff3=FakeElectronDiEMPtPrompt->FindBin(DIEMPTprompt);
      float Weightff3=FakeElectronDiEMPtPrompt->GetBinContent(Binff3);
      int Binff4=FakeElectronRhoPrompt->FindBin(rhoprompt);
      float Weightff4=FakeElectronRhoPrompt->GetBinContent(Binff4);
      int Binff44=FakeElectrondiEMPtReweightedRhoPrompt->FindBin(rhoprompt);
      float Weightff44=FakeElectrondiEMPtReweightedRhoPrompt->GetBinContent(Binff44);
      h_met_prompt_ffdiEMPtreweighted->Fill(metetprompt,Weightff3);
      h_met_prompt_ffrhoreweighted->Fill(metetprompt,Weightff4);
      h_met_prompt_ffrhodiEMPtreweighted->Fill(metetprompt, Weightff3*Weightff4);
      h_met_prompt_ffdiEMPtrhodiEMPtreweighted->Fill(metetprompt, Weightff44*Weightff3);
      h_met_prompt_ffdiEMPtrhoreweighted->Fill(metetprompt, Weightff44);



      h_rho_prompt_ffdiEMPtreweighted->Fill(rhoprompt, Weightff3);

      h_rho_prompt->Fill(rhoprompt);
      ...
      h_rho_difference->Fill(rho-rhoprompt);
