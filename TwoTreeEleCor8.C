...
void TwoTreeEleCor8(){
  ...
  //// histograms ////
  TFile *FF = new TFile("PromptRecoElectronCorPfMet8.root","RECREATE");
  ...
  FILE *myfile;
  myfile=fopen("file_ele_ReReco8_Sorted.txt", "r");
  char line[50];
  int z1=0;
  const int linesize = 114158 ;
  ...
  for(int f=0;f<linesize;++f){
    FILE *myfile1;
    myfile1=fopen("file_ele_Prompt8_Sorted.txt", "r");
    char line1[50];
