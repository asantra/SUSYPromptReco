...
void TwoTreeEleCor6(){
  ...
  //// histograms ////
  TFile *FF = new TFile("PromptRecoElectronCorPfMet6.root","RECREATE");
  ...
  FILE *myfile;
  myfile=fopen("file_ele_ReReco6_Sorted.txt", "r");
  char line[50];
  int z1=0;
  const int linesize = 325450 ;
  ...
  for(int f=0;f<linesize;++f){
    FILE *myfile1;
    myfile1=fopen("file_ele_Prompt6_Sorted.txt", "r");
    char line1[50];
