...
void TwoTreeEleCor7(){
  ...
  //// histograms ////
  TFile *FF = new TFile("PromptRecoElectronCorPfMet7.root","RECREATE");
  ...
  FILE *myfile;
  myfile=fopen("file_ele_ReReco7_Sorted.txt", "r");
  char line[50];
  int z1=0;
  const int linesize = 284109 ;
  ...
  for(int f=0;f<linesize;++f){
    FILE *myfile1;
    myfile1=fopen("file_ele_Prompt7_Sorted.txt", "r");
    char line1[50];
