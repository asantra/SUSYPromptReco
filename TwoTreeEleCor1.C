...
void TwoTreeEleCor1(){
  ...
  //// histograms ////
  TFile *FF = new TFile("PromptRecoElectronCorPfMet1.root","RECREATE");
  ...
  FILE *myfile;
  myfile=fopen("file_ele_ReReco1_Sorted.txt", "r");
  char line[50];
  int z1=0;
  const int linesize = 99574 ;
  ...
  for(int f=0;f<linesize;++f){
    FILE *myfile1;
    myfile1=fopen("file_ele_Prompt1_Sorted.txt", "r");
    char line1[50];
